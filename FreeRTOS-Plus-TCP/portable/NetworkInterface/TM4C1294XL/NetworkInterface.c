    ...
    for (;;)
    {
        ...
        if (xBytesReceived > 0)
        {
            ...
            if (pxBufferDescriptor != NULL)
            {
                ...
                configASSERT(
                        memcpy( (void*)(pxBufferDescriptor->pucEthernetBuffer), (void*)(g_psRxDescriptor[g_ui32RxDescIndex].pvBuffer1), pxBufferDescriptor->xDataLength) != NULL);//xBytesReceived
            ...
            else// case when pxBufferDescriptor is NULL
            {
                ...
                & DES0_RX_CTRL_OWN))
        {
            ...
            DES0_RX_STAT_ERR))
            {
                ...
                DES0_RX_STAT_LAST_DESC)
                {
                    ...
                    vTaskNotifyGiveFromISR(PacketRxTask,
        ...
        BaseType_t xReleaseAfterSend)
{
    ...
    PacketTransmit(pxNetworkBuffer->pucEthernetBuffer,
